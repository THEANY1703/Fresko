              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if ((currentUserDocument?.role == Role.Organaizer) ||
                        (currentUserDocument?.role == Role.OwnerOrganization))
                    ...
                    if ((currentUserDocument?.role == Role.Organaizer) ||
                      ...
                      AuthUserStreamWidget(
                        builder: (context) => InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            if (currentUserDocument?.organization == null) {
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            context.goNamedAuth('EnterPage', context.mounted);
                          },
                          text: 'Esci',
                          icon: const Icon(
                            Icons.logout,
                                        ...
                                        return Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 10.0, 0.0),
                                          child:
                                              FutureBuilder<List<TicketRecord>>(
                                            future: queryTicketRecordOnce(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<TicketRecord>
                                                  containerTicketRecordList =
                                                  snapshot.data!;
                                              // Return an empty Container when the item does not exist.
                                              if (snapshot.data!.isEmpty) {
                                                return Container();
                                              }
                                              final containerTicketRecord =
                                                  containerTicketRecordList
                                                          .isNotEmpty
                                                      ? containerTicketRecordList
                                                          .first
