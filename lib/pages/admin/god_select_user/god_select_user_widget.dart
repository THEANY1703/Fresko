...
class GodSelectUserWidget extends StatefulWidget {
  const GodSelectUserWidget({super.key});

  @override
  State<GodSelectUserWidget> createState() => _GodSelectUserWidgetState();
}

class _GodSelectUserWidgetState extends State<GodSelectUserWidget> {
  late GodSelectUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GodSelectUserModel());
