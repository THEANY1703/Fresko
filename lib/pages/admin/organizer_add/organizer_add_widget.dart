...
import 'organizer_add_model.dart';
export 'organizer_add_model.dart';

class OrganizerAddWidget extends StatefulWidget {
  const OrganizerAddWidget({super.key});

  @override
  State<OrganizerAddWidget> createState() => _OrganizerAddWidgetState();
}

class _OrganizerAddWidgetState extends State<OrganizerAddWidget> {
  late OrganizerAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrganizerAddModel());
                        ...
                        onPressed: () async {
                          _model.userAdded = await queryUserRecordOnce(
                            queryBuilder: (userRecord) => userRecord.where(
                              'email',
                              isEqualTo: _model.dispalyTitleTextController.text,
                            ),
                            singleRecord: true,
                          ...
                          await _model.userAdded!.reference
                            ...
                            role: Role.OwnerOrganization,
                          ));

                          safeSetState(() {});
                        },
                        text: 'Aggiungi Organizzatore',
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            cancelButton:
                                                                                'Cancella',
                                                                            userName:
                                                                                _model.userSelected?.displayName,
                                                                            desc3:
                                                                                'Dalla tua organizzazione?',
                                                                            confirmCallback:
                                                                                () async {
                                                                              await _model.userSelected!.reference.update(createUserRecordData(
                                                                                role: Role.User,
                                                                              ));
                                                                            },
                                                                          ),
