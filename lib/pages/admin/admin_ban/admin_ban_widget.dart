...
import 'admin_ban_model.dart';
export 'admin_ban_model.dart';

class AdminBanWidget extends StatefulWidget {
  const AdminBanWidget({super.key});

  @override
  State<AdminBanWidget> createState() => _AdminBanWidgetState();
}

class _AdminBanWidgetState extends State<AdminBanWidget> {
  late AdminBanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminBanModel());
                                    ...
                                    fieldViewBuilder: (
                                      ...
                                      return TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText:
                                              'Inserisci l\'username da bannare',
                                          hintStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium
                                                  .override(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          await _model.userAdded!.reference.delete();

                          safeSetState(() {});
                        },
                        text: 'Confermi di bannare',
