  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PrListRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PrListRecord> organizationPagePrListRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final organizationPagePrListRecord =
            organizationPagePrListRecordList.isNotEmpty
                ? organizationPagePrListRecordList.first
                : null;
                                ...
                                context.pushNamed(
                                  ...
                                  queryParameters: {
                                    ...
                                    'prList': serializeParam(
                                      organizationPagePrListRecord?.reference,
                                      ParamType.DocumentReference,
                                    ),
                                  }.withoutNulls,
                                );
