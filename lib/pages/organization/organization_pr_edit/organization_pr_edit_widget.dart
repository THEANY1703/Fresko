...
class OrganizationPrEditWidget extends StatefulWidget {
  const OrganizationPrEditWidget({
    super.key,
    this.orgRef,
  });
  ...
  @override
  State<OrganizationPrEditWidget> createState() =>
      _OrganizationPrEditWidgetState();
}

class _OrganizationPrEditWidgetState extends State<OrganizationPrEditWidget> {
  late OrganizationPrEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrganizationPrEditModel());
                                          ...
                                          fieldViewBuilder: (
                                            ...
                                            return TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                hintText:
                                                    'Inserisci l\'email del nuovo PR',
                                                hintStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        .override(
                            ...
                            children: [
                              Expanded(
                                child: Builder(
                                  builder: (context) {
                                    final user =
                                        organizationPrEditOrganizationRecord
                                            .members
                                            .toList();
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      onPressed:
                                                                          () async {
                                                                        _model.userSelected =
                                                                            await UserRecord.getDocumentOnce(userItem);
                                                                        await showDialog(
                                                                          context:
                                                                              context,
                                                                          builder:
