                                ...
                                builder: (dialogContext) {
                                  return Dialog(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: DialogWidget(
                                        title:
                                            'Vuoi veramente modificare il tuo evento?',
                                        dettails:
                                            'L\'azione sarà irreversibile, se clicchi conferma confermerai di modificare l\'evento con i dati inseriti',
                                        confirmCB: () async {
                                          _model.locationRef =
                                          ...
                                          _model.selected =
                                              await queryEventTagsRecordOnce(
                                            queryBuilder: (eventTagsRecord) =>
                                                eventTagsRecord.where(
                                              'event',
                                              isEqualTo:
                                          ...
                                          await _model.selected!.reference
                                              .update({
                                            ...mapToFirestore(
                                              {
