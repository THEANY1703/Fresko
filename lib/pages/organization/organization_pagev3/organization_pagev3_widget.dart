...
import 'organization_pagev3_model.dart';
export 'organization_pagev3_model.dart';

class OrganizationPagev3Widget extends StatefulWidget {
  const OrganizationPagev3Widget({
    super.key,
  ...
  @override
  State<OrganizationPagev3Widget> createState() =>
      _OrganizationPagev3WidgetState();
}

class _OrganizationPagev3WidgetState extends State<OrganizationPagev3Widget>
    with TickerProviderStateMixin {
  late OrganizationPagev3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrganizationPagev3Model());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PrListRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PrListRecord> organizationPagev3PrListRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final organizationPagev3PrListRecord =
            organizationPagev3PrListRecordList.isNotEmpty
                ? organizationPagev3PrListRecordList.first
                : null;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              top: true,
              child: StreamBuilder<OrganizationRecord>(
                                ...
                                context.pushNamed(
                                  ...
                                  queryParameters: {
                                    ...
                                    'prList': serializeParam(
                                      organizationPagev3PrListRecord?.reference,
                                      ParamType.DocumentReference,
                                    ),
                                  }.withoutNulls,
                                );
