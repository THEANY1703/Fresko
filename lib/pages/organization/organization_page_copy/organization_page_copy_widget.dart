...
import 'organization_page_copy_model.dart';
export 'organization_page_copy_model.dart';

class OrganizationPageCopyWidget extends StatefulWidget {
  const OrganizationPageCopyWidget({
    super.key,
  ...
  @override
  State<OrganizationPageCopyWidget> createState() =>
      _OrganizationPageCopyWidgetState();
}

class _OrganizationPageCopyWidgetState extends State<OrganizationPageCopyWidget>
    with TickerProviderStateMixin {
  late OrganizationPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrganizationPageCopyModel());
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: StreamBuilder<OrganizationRecord>(
            stream:
                OrganizationRecord.getDocument(widget.organizationReference!),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        if (currentUserDocument?.listSelected != null)
                          AuthUserStreamWidget(
