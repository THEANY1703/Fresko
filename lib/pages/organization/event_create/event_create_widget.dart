                              ...
                              child: StreamBuilder<List<TagRecord>>(
                                stream: queryTagRecord(
                                  queryBuilder: (tagRecord) =>
                                    ...
                                    _model.tagDropDownPreviousSnapshot =
                                        snapshot;
                                  }),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                ...
                                builder: (dialogContext) {
                                  return Dialog(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: DialogWidget(
                                        title:
                                            'Vuoi veramente creare il tuo evento?',
                                        dettails:
                                            'L\'azione sarà irreversibile, se clicchi conferma confermerai di creare l\'evento con i dati inseriti da te',
                                        confirmCB: () async {
                                          _model.locationRef =
                                          ...
                                          await NotificationRecord.collection
                                              ...
                                              .set(createNotificationRecordData(
                                                name: 'Nuovo evento caricato',
                                                description:
                                                    'Un organizzazione ha appena aggiunto ${_model.eventCreated?.name}al  ${_model.locationRef?.displayName}giorno ${functions.formatDateTime(_model.eventCreated!.dateEvent!)}',
